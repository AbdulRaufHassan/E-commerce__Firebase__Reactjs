  ...
  return (
    <div className="w-full h-auto box-border mb-6">
      ...
      <ul className="min-w-fit max-w-fit mx-auto h-auto box-border pt-14 flex justify-center flex-wrap top_collection">
        <li className="flex flex-col items-center min-w-[300px] max-w-[300px] h-auto rounded-2xl bg-white box-border m-2 overflow-hidden single_product">
          <div className="w-full h-auto px-2 py-6 cursor-pointer bg-gray-300 flex items-center justify-center product_img_div">
